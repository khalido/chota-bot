// 19:15 Sydney print of *tomorrow's* brief — one sheet per family member
...
// auto-omits when tomorrow isn't a school day. Runs Sun–Thu only: those nights
// print the Mon–Fri school-day briefs, while Fri/Sat nights (a weekend brief)
// are skipped. The puzzle and "did you know" fact are dropped (sections.ts) —
// this is a get-ready sheet. One recipient failing doesn't stop the rest.
//
...
// `0-4` = Sun–Thu (cron: Sun=0). Fri/Sat nights would print a weekend brief.
defineJob('evening-print', '15 19 * * 0-4', async () => {
