	...
	<div class="mx-auto max-w-4xl space-y-8">
		{#if !data.weather}
			<section>
				...
				<p class="mt-6 text-lg text-slate-500 dark:text-neutral-400">Weather unavailable.</p>
				<p class="mt-1 text-sm text-slate-400 dark:text-neutral-600">
					Couldn't reach the weather service — it'll reappear once the feed is back.
				</p>
			</section>
		{:else}
			<!-- Current + headline -->
